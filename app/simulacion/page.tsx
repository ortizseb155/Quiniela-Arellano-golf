...
export default function SimulacionPage() {
  ...
  function computeStandings() {
    ...
    const result: TeamStanding[] = Object.entries(allPicks).map(([participantId, picks]) => {
      ...
      const round12 = roster.reduce((sum, r) => sum + r.round1 + r.round2, 0);
      ...
      const bonuses = roster.reduce((sum, r) => sum + r.cutBonus + r.finishBonus, 0);
      const total = round12 + round3Top4 + round4Top4 + bonuses;
